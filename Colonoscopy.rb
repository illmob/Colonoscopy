...
gt  = "\x09\x09\x5b\x4d\x6f\x74\x6f\x2f\x50\x53\x41\x5d\x3a\x09\x47\x65"
gt += "\x74\x20\x79\x6f\x20\x73\x68\x69\x74\x20\x63\x68\x65\x63\x6b\x65\x64\x21"
banner = []
banner.append('-'*80)
...
banner.append('\x20'*18+".;dKMMWOl'"+"\x20"*21+"..,.......:MMo"+"\x20"*6+"0MM'")
banner.append('\x20'*23+".;xXMMWOc."+"\x20"*14+":;:o,;c;:;l:'xMM:dolccclxk:")
banner.append('\x20'*25+",xWMM0c."+"\x20"*14+",:'.'.'.."+"\x20"*3+":MM0.,:cccoxxoo:.")
...
banner.append('\x20'*12+",xNMM0c."+"\x20"*21+".c0MMMMMMMWKkl'"+"\x20"*6+".;dNMMk."+"\x20"*7+".klk;")
banner.append('\x20'*9+"'dNMMKl."+"\x20"*21+".c0MMWx,"+"\x20"*1+"..."+"\x20"*3+".lKNK00XWMMM0l."+"\x20"*11+"klO,")
banner.append('\x20'*7+",KMMKl."+"\x20"*22+":OMMWk;"+"\x20"*7+".lKMMNxxxxdo:'"+"\x20"*16+"O:0.")
...
banner.append('\x20'*9+".kMMK;"+"\x20"*18+"oWMWx."+"\x20"*1+"oWMWo"+"\x20"*38+"0:0")
banner.append('\x20'*10+".kMMK;"+"\x20"*18+"oWMWx."+"\x20"*1+"oWMWo"+"\x20"*37+"oc0.")
banner.append('\x20'*12+".kMMK;"+"\x20"*18+"oWMWx."+"\x20"*1+"oWMWo"+"\x20"*35+".0cd")
...
banner.append('\x20'*27+"oWMWo"+"\x20"*18+",0MMK,"+"\x20"*1+",0MM0,")
banner.append('\x20'*29+"oWMWo"+"\x20"*18+",0MMx"+"\x20"*1+",0MM0,")
banner.append('\x20'*31+"oWMWo"+"\x20"*18+"xMMo"+"\x20"*3+",0MM0.")
...
banner.append('\x20'*42+"cXMMWKOO0NMMMk."+"\x20"*7+"lWMX.")
banner.append('\x20'*43+".;ldxxxokWMWOo:;:lkNMWd.")
banner.append('\x20'*53+";d0NMMMWXk:")
banner.append('-'*80)
